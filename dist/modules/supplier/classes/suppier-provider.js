...
class SupplierProviderService {
    ...
    defaultSupplierPreference() {
        return {
            supplierWeighting: enums_1.SupplierWeighting.quoteToCostRatio,
            defaultInvites: 3,
            maxInvites: 5,
            minInvites: 1,
        };
    ...
    sortBySupplierPreference(suppliers, supplierWeighting) {
        switch (supplierWeighting) {
            case enums_1.SupplierWeighting.avgQuoteResponse:
                suppliers.sort(this._sortByAvgQuoteResponse);
                break;
            case enums_1.SupplierWeighting.quoteToCostRatio:

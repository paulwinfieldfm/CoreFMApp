...
(function (EntityState) {
    ...
    EntityState[EntityState["quoteAcceptedWithoutOrder"] = 6] = "quoteAcceptedWithoutOrder";
    EntityState[EntityState["orderAccepted"] = 7] = "orderAccepted";
    EntityState[EntityState["quotationChatMessageSent"] = 8] = "quotationChatMessageSent";
    EntityState[EntityState["orderChatMessageSent"] = 9] = "orderChatMessageSent";
    EntityState[EntityState["visitChatMessageSent"] = 10] = "visitChatMessageSent";
    EntityState[EntityState["jobOnHold"] = 11] = "jobOnHold";
    EntityState[EntityState["jobCompleted"] = 12] = "jobCompleted";
    EntityState[EntityState["quoteCancelled"] = 13] = "quoteCancelled";
    EntityState[EntityState["orderCancelled"] = 14] = "orderCancelled";
...
(function (EntityStatus) {
    ...
    EntityStatus[EntityStatus["quoteAccepted"] = 3] = "quoteAccepted";
    EntityStatus[EntityStatus["raised"] = 4] = "raised";
    EntityStatus[EntityStatus["orderAccepted"] = 5] = "orderAccepted";
    EntityStatus[EntityStatus["booked"] = 6] = "booked";
    EntityStatus[EntityStatus["onRoute"] = 7] = "onRoute";
    EntityStatus[EntityStatus["atSite"] = 8] = "atSite";
    EntityStatus[EntityStatus["onSite"] = 9] = "onSite";
    EntityStatus[EntityStatus["inProgress"] = 10] = "inProgress";
    EntityStatus[EntityStatus["onHold"] = 11] = "onHold";
    EntityStatus[EntityStatus["completed"] = 12] = "completed";
    EntityStatus[EntityStatus["signOff"] = 13] = "signOff";
    EntityStatus[EntityStatus["cancelled"] = 14] = "cancelled";
    EntityStatus[EntityStatus["clonedQuote"] = 15] = "clonedQuote";

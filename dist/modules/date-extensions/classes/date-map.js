...
class DateMap {
    constructor(date, epoch) {
        this._includeSeconds = false;
        this.epoch = epoch;
        this._date = date;
    }
    static fromEpoch(epoch) {
        return new DateMap(date_helper_1.DateHelper.epochToDate(epoch), epoch);
    }
    static fromDate(date) {
        return new DateMap(date, date_helper_1.DateHelper.dateToEpoch(date));
    }
    static fromEmpty() {
    ...
    get time() {
        ...
        return date_helper_1.DateHelper.localeTime(this._date, this._includeSeconds);
    }
    set time(value) {
    ...
    _updateDate(value) {
        this._date = value;
        this.epoch = value ? date_helper_1.DateHelper.dateToEpoch(this._date) : undefined;
    }

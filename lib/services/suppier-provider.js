...
class SupplierProviderService {
    ...
    _sortByAvgQuoteResponse(supplier1, supplier2) {
        const supplier1HasValue = this._hasMinimumValue(supplier1.avgQuoteResponse, 5);
        const supplier2HasValue = this._hasMinimumValue(supplier2.avgQuoteResponse, 5);
    ...
    _sortByQuoteToCostRatio(supplier1, supplier2) {
        ...
        const supplier1HasValue = this._hasMinimumValue(supplier1.quoteToCostRatio, 5);
        const supplier2HasValue = this._hasMinimumValue(supplier2.quoteToCostRatio, 5);
    ...
    _sortByRating(supplier1, supplier2) {
        const supplier1HasValue = this._hasMinimumValue(supplier1.rating, 1);
        const supplier2HasValue = this._hasMinimumValue(supplier2.rating, 1);
    ...
    _hasMinimumValue(field, minValue) {
        return utilities_1.Utils.hasValue(field) && field >= minValue;
    }
}

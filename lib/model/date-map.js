...
class DateMap {
    ...
    static fromEpoch(epoch) {
        return new DateMap(utilities_1.DateHelper.epochToDate(epoch), epoch);
    }
    static fromDate(date) {
        return new DateMap(date, utilities_1.DateHelper.dateToEpoch(date));
    }
    static fromEmpty() {
    ...
    _updateDate(value) {
        this._date = value;
        this.epoch = value ? utilities_1.DateHelper.dateToEpoch(this._date) : undefined;
    }

...
class Customer {
    ...
    static assign(id, uid, customerId, photoURL, displayName, name, contactName, email, contactEmail, contactPhone1, address1, address2, town, postcode, companyName, attributes = {}) {
        var _a, _b;
        return ({
            id: id,
            uid: uid,

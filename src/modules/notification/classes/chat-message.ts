import { ILinkedEntityInfo, IContact } from "../../base";
...
export class ChatMessage implements IChatMessage {
    ...
    content!: string;
    linkedEntity: ILinkedEntityInfo | undefined;
    time!: number;
    ...
    static create(id: string, sender: IContact, content: string, supplierId: number | undefined, organisationUnitId: number | undefined, linkedEntity: ILinkedEntityInfo | undefined) {
